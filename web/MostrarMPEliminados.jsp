        ...
        <form id="frmMostrarCuerpoMPEliminados">
            <table id="tablaMostrarCuerpoMPEliminados">
                ...
                <tr>
                    ...
                    <td class="Opcion">
                        <input type="button" name="btnRecuperar" id="btnRecuperar" class="button" value="Recuperar" onclick="location.href='Servlet_MP?codigoMP=<%=MP.getIdMarca_Producto() %>&&accion=recuperar'">
                    </td>
                </tr>
