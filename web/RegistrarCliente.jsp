                                ...
                                <div class="form-group" >
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <input type="button" name="btnCancelar" id="btnCancelar" class="form-control btn btn-danger" value="Cancelar">
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                            <input type="button" name="btnRegistrar" id="btnRegistrar" class="form-control btn btn-success" value="Registrar">
                                        </div>
                                    </div>
                                </div>
