        ...
        <form name="frm" action="ServletProducto" method="post" id="frmModificarProd">
            <table id="tablaModificarProd">
                ...
                <tr>
                    ...
                    <td>
                        <dd> <input type="text" name="txtNombreCP" id="txtNombreCP" value="<%=p.getClase_Producto()%>" size="30" maxlength="30"> </dd>
                    </td>
                </tr>
                <tr>
                    <td class="primeraColumna">
                    ...
                    <td>
                        <dd> <input type="text" name="txtNombreMP" id="txtNombreMP" value="<%=p.getMarca_Producto()%>" size="30" maxlength="30"> </dd>
                    </td>
                </tr>
                <tr>
                    <td class="primeraColumna">
