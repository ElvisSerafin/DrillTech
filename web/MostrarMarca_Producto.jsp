        ...
        <form id="frmMostrarCuerpoMP">
            <table id="tablaMostrarCuerpoMP">
                ...
                <tr>
                    ...
                    <td class="Opcion">
                        <input type="button" name="btnModificar" id="btnModificar" class="button" value="Modificar" onclick="location.href='ModificarMP.jsp?codigoMP=<%=MP.getIdMarca_Producto() %>&&nombreMP=<%=MP.getNombreMP() %>&&estadoMP=<%=MP.getEstadoMP() %>'">
                    </td>
                    <td class="Opcion">
                        <input type="button" name="btnEliminar" id="btnEliminar" class="button" value="Eliminar" onclick="location.href='Servlet_MP?codigoMP=<%=MP.getIdMarca_Producto() %>&&accion=eliminar'">
                    </td>
                </tr>
